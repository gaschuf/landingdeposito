...
if (!empty($_FILES)) {
 ...
 $filesUploaded = moveFiles($_POST);
function moveFiles($files)
{
    $inputFileName = "imagen"; //nombre del Input origen (ejemplo name="archivo[]" --tomar solo--> archivo
    $uploadDirectory = "../img/uploads/productos"; //ubicacion y nombre del directorio donde se guarda
    $fileLocations = array();
